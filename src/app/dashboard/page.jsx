          ...
          <div className="bg-white rounded-lg p-3 mb-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex gap-10 items-center flex-wrap">
                <Link href="/dashboard/newpost" className="flex items-center gap-2 text-sm">
                  <Image src="/images/photo.png" alt="icon" width={30} height={30} />
                  Photo/Video
                </Link>
                <Link href="/dashboard/newpost" className="flex items-center gap-2 text-sm">
                  <Image src="/images/content.png" alt="icon" width={30} height={30} />
                  Content
                </Link>
              </div>
